...
const EnhancedHero = () => {
  ...
  const playSoundAndOpenWhatsApp = () => {
    ...
    const message = encodeURIComponent(
      "Hi Skip Media, I'm interested in working with you."
    );
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-black font-inter selection:bg-primary/30">
      ...
      >
        ...
        {/* Small Label */}
        <div className="mb-6">
          <span className="text-white/80 text-xs md:text-sm tracking-[0.4em] uppercase bg-black/60 px-6 py-2 rounded-full backdrop-blur-md border border-white/10 shadow-lg">Video Editor | 2025</span>
        </div>

        {/* Main Title - Skip Media */}
        <h1 className="text-7xl md:text-9xl lg:text-[10rem] font-bold tracking-tighter mb-10 drop-shadow-2xl text-center leading-none">
          ...
          <span className="glow-text-blue inline-block ml-4 hover:scale-105 transition-transform duration-300 cursor-default">M</span>
